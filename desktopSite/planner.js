...
var markerEnd;
       ...
       // map.setCenter(new GLatLng(49.400000, -122.845783),10);
        ...
        var reasons=[];
        //do this//reasons[G_GEO_SUCCESS]            = "Success";
        //do this//reasons[G_GEO_MISSING_ADDRESS]    = "Missing Address: The address was either missing or had no value.";
        //do this//reasons[G_GEO_UNKNOWN_ADDRESS]    = "Unknown Address:  No corresponding geographic location could be found for the specified address.";
        //do this//reasons[G_GEO_UNAVAILABLE_ADDRESS]= "Unavailable Address:  The geocode for the given address cannot be returned due to legal or contractual reasons.";
        //do this//reasons[G_GEO_BAD_KEY]            = "Bad Key: The API key is either invalid or does not match the domain for which it was given";
        //do this//reasons[G_GEO_TOO_MANY_QUERIES]   = "Too Many Queries: The daily geocoding quota for this site has been exceeded.";
        //do this//reasons[G_GEO_SERVER_ERROR]       = "Server error: The geocoding request could not be successfully processed.";
        ...
        geo.geocode({ 'address': addrStart}, function(results, status) {
            if (addrStart == "") {
            ...
            if (status == google.maps.GeocoderStatus.OK) {
                ...
                geo.geocode({ 'address': addrEnd}, function(results, status) {
                    if (addrEnd == "") {
                        //document.getElementById("feedback").style.fontSize= "small";
                    ...
                    // If that was successful
                    if (status == google.maps.GeocoderStatus.OK) {
						var p2 = results[0].geometry.location;				
						var lat2 = p2.k;
						var lng2 = p2.A;
                            ...
                            if (nodesCount > 0) { //prevent first webservice call to run this code.
                                ...
                                for (var i = 0; i < nodesCount - 1; i++) {
                                    ...
                                    var path =[
										...
										new google.maps.LatLng(latlng2[0], latlng2[1]),
									]
                                    ...
                                    //KMLRoute = new GGeoXml("http://www.cyclevancouver.ubc.ca/KMLRoutes/' + txtFile + '"); 
                        ...
                        ret = RouteService.NodeCoords(RouteType, RoutePreference, RouteSpeed, RouteSlope, lng1, lat1, lng2, lat2, txtFile, OnComplete, OnTimeOut, OnError);
            ...
            //  Decode the error status
                ...
                //document.getElementById("rtesearch").style.width = "1px";
                //document.getElementById("feedback").style.width = "200px";
                document.getElementById("feedback").innerHTML = "Start address unrecognizable:" + reason;
